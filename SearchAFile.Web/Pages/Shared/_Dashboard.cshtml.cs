...
namespace SearchAFile.Web.Pages.Shared;
...
public class _DashboardModel : PageModel
{
    ...
    public _DashboardModel(TelemetryClient telemetryClient, AuthenticatedApiClient api)
    {
    ...
    public async Task OnGetAsync(bool is_private = true)
    {
        try
        {
            ...
            if (is_private)
            {
                Collections = collectionResult.Data
                    ...
                    .Where(collection => collection.Private)
